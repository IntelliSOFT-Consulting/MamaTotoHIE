...
exports.parseFHIRBundle = exports.parseMedication = exports.parseEncounterResource = exports.Observation = exports.parseObservationResource = exports.getPatientByCrossBorderId = exports.generateCrossBorderId = exports.getPatientSummary = exports.createClient = exports.sendRequest = exports.parseIdentifiers = exports.FhirApi = exports.apiHost = exports.installChannels = exports.getOpenHIMToken = exports.importMediators = void 0;
...
const beneficiaryMediator_json_1 = __importDefault(require("../config/beneficiaryMediator.json"));
const https_1 = require("https");
const crypto = __importStar(require("crypto"));
// mediators to be registered
const mediators = [
    shrMediatorConfig_json_1.default,
    beneficiaryMediator_json_1.default
];
...
const sendRequest = () => __awaiter(void 0, void 0, void 0, function* () {
    let headers = yield exports.getOpenHIMToken();
    [shrMediatorConfig_json_1.default.urn].map((urn) => __awaiter(void 0, void 0, void 0, function* () {
        let response = yield (yield fetch(`${openhimApiUrl}/patients`, {
            headers: Object.assign(Object.assign({}, headers), { "Content-Type": "application/json" }),
            method: 'POST', body: JSON.stringify({ a: "y" }), agent: new https_1.Agent({
                rejectUnauthorized: false
            })
        })).text();
        console.log(response);
...
const getPatientSummary = (crossBorderId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let patient = yield exports.getPatientByCrossBorderId(crossBorderId);
        console.log(patient);
...
const getPatientByCrossBorderId = (crossBorderId) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    try {
...
exports.getPatientByCrossBorderId = getPatientByCrossBorderId;
const parseObservationResource = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let codes = data;
        // { observation, value }
    }
...
exports.parseObservationResource = parseObservationResource;
const Observation = (patientId, codes, encounterId) => {
    try {
        return {
...
const parseEncounterResource = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    }
    catch (error) {
        console.log(error);
...
exports.parseEncounterResource = parseEncounterResource;
const parseMedication = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    }
    catch (error) {
        console.log(error);
...
const parseFHIRBundle = (params) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // return {}
    }
    catch (error) {
