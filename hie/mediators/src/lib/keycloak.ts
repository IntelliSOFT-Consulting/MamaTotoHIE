...
const KC_BASE_URL = String(process.env.KC_BASE_URL);
const KC_REALM = String(process.env.KC_REALM);
const KC_CLIENT_ID = String(process.env.KC_CLIENT_ID);
const KC_CLIENT_SECRET = String(process.env.KC_CLIENT_SECRET);
